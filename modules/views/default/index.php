   <!-- main container -->
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div id="pad-wrapper">
                ...
                <!-- table sample -->
                <!-- the script for the toggle all checkboxes from header is located in static/admin/js/theme.js -->
                            ...
                            <tbody>
                                ...
                                <tr class="first">
                                    <td>
                                        <input type="checkbox" />
                                        <div class="img">
                                            <img src="static/admin/img/table-img.png" />
                                        </div>
    ...
    <!-- knob -->
    <script src="static/admin/js/jquery.knob.js"></script>
    <!-- flot charts -->
    ...
    <script src="static/admin/js/wysihtml5-0.3.0.js"></script>
    <script src="static/admin/js/bootstrap-wysihtml5-0.0.2.js"></script>
