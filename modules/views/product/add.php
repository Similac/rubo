                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                                ...
                                echo $form->field($model, 'cateid')->dropDownList($opts, ['id' => 'cates','class' => 'span8']);
                                echo $form->field($model, 'title')->textInput(['class' => 'span8']);
                                echo $form->field($model, 'descr')->textarea(['id' => "wysi", 'class' => "span8 wysihtml5",]);
                                echo $form->field($model, 'price')->textInput(['class' => 'span8']);
                                echo $form->field($model, 'ishot')->radioList([0 => '不热卖', 1 => '热卖'], ['class' => 'span8']);
                                echo $form->field($model, 'issale')->radioList(['不促销', '促销'], ['class' => 'span8']);
                                echo $form->field($model, 'saleprice')->textInput(['class' => 'span8']);
                                echo $form->field($model, 'num')->textInput(['class' => 'span8']);
                                echo $form->field($model, 'ison')->radioList(['下架', '上架'], ['class' => 'span8']);
                                echo $form->field($model, 'istui')->radioList(['不推荐', '推荐'], ['class' => 'span8']);
                                echo $form->field($model, 'cover')->fileInput(['class' => 'span8']);
